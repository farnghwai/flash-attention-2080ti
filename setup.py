...
def cuda_archs() -> str:
    ...
    return os.getenv("FLASH_ATTN_CUDA_ARCHS", "75").split(";")
    ...
    ext_modules.append(
        CUDAExtension(
            ...
            sources=[
                ...
                "csrc/flash_attn/src/flash_fwd_hdim32_fp16_sm75.cu",
                ...
                "csrc/flash_attn/src/flash_fwd_hdim160_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_hdim192_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_hdim256_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_hdim32_fp16_causal_sm75.cu",
                ...
                "csrc/flash_attn/src/flash_fwd_hdim160_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_hdim192_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_hdim256_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim32_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim64_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim96_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim32_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim64_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim96_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_bwd_hdim32_fp16_sm75.cu",
                ...
                "csrc/flash_attn/src/flash_bwd_hdim160_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_fp16_sm75.cu",
                "csrc/flash_attn/src/flash_bwd_hdim32_fp16_causal_sm75.cu",
                ...
                "csrc/flash_attn/src/flash_bwd_hdim160_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_fp16_causal_sm75.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_fp16_causal_sm75.cu",                
            ],
            extra_compile_args={
                "cxx": ["-O3", "-std=c++17"],
